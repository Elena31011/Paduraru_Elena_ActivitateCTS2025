...
public class Main {
    public static void main(String[] args) {
        ...
        receptie.getPacient("1234567", "Maria", "0711000222", "Bucuresti, Bd.Elis, Nr.211A");
        ...
        try {
            receptie.getPacient("1234567").detaliiPacient(spitalizare1);
            receptie.getPacient("1234567").detaliiPacient(spitalizare2);
            receptie.getPacient("5010515").detaliiPacient(spitalizare3);
            receptie.getPacient("6030911").detaliiPacient(spitalizare4);
            receptie.getPacient("1234567").detaliiPacient(spitalizare4);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
